...
set label 1 gprintf("Mean = %g", STATS_mean) at 0.08,5.5
set label 2 gprintf("Std. Err = %g", STATS_stddev/sqrt(STATS_records)) at 0.08,5
set label 3 "Dim: 400" at 0.08,4.5
set arrow from STATS_mean,0 to STATS_mean,7 nohead lc rgb 'blue'
